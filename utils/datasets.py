...
#     #args.test_path = "/media/yan/小可爱SaMa2号/GTSRB/orgianl/test"
#     #args.b = 8
#     cifar100_training_loader = get_GTSRB_train_dataloader(root="/media/yan/小可爱SaMa2号/GTSRB/ORGINAL/train",
#         mean=(0.5, 0.5, 0.5),
#         std=(0.5, 0.5, 0.5),
#         num_workers=0,
#         batch_size=8,
#         shuffle=True)
#     train_dataset=cifar100_training_loader
#     cifar100_test_loader = get_GTSRB_test_dataloader(root="/media/yan/小可爱SaMa2号/GTSRB/ORGINAL/test",
#         mean=(0.5, 0.5, 0.5),
#         std=(0.5, 0.5, 0.5),
#         num_workers=0,
#         batch_size=8,
#         shuffle=True)
#     test_dataset=cifar100_test_loader
#
#
#
#     return input_size, num_classes, train_dataset, test_dataset
